<template>
  <div class="p-2">
    <p class="text-blue-2 text-center">کارفرما حقوقی</p>
    <div class="mt-4">
      <form @submit.prevent>
        <template v-if="showStepOne">
          <div class="form-group">
            <label>کد ملی(کارفرما / نماینده کارفرما)</label>
            <InputText
        ...
        <template v-else>
          ...
          <div class="form-group">
            ...
            <InputText
                :class="{'p-invalid': v$.companyNationalCode.$invalid && submitted}"
                type="text"
                v-model="stepOneForm.companyNationalCode"
                class="w-100"/>
          </div>
          ...
          <button @click="onSubmitStepOne()" class="btn btn-success w-100 mt-2" type="button">
            ثبت نام
          </button>
